lines_gold = open("./data/Lezgi/lez-test-track1-uncovered", "rb").readlines()
lines_gold = [line_gold.decode(errors='ignore').strip() for line_gold in lines_gold]

#lines = open("./predictions/lez_track1_morph_trial1.prediction", "rb").readlines()
#lines = [line.decode(errors='ignore').strip() for line in lines]

#lines2 = open("./predictions/lez_track1_morph_trial2.prediction", "rb").readlines()
#lines2 = [line2.decode(errors='ignore').strip() for line2 in lines2]

lines3 = open("./predictions/lez_track1_morph_trial3.prediction", "rb").readlines()
lines3 = [line3.decode(errors='ignore').strip() for line3 in lines3]

lines4 = open("./predictions/lez_track1_morph_trial4.prediction", "rb").readlines()
lines4 = [line4.decode(errors='ignore').strip() for line4 in lines4]

lines5 = open("./predictions/lez_track1_morph_trial5.prediction", "rb").readlines()
lines5 = [line5.decode(errors='ignore').strip() for line5 in lines5]

#lines6 = open("./predictions/lez_track1_morph_trial6.prediction", "rb").readlines()
#lines6 = [line6.decode(errors='ignore').strip() for line6 in lines6]

#lines7 = open("./predictions/lez_track1_morph_trial7.prediction", "rb").readlines()
#lines7 = [line7.decode(errors='ignore').strip() for line7 in lines7]

lines8 = open("./predictions/lez_track1_morph_trial8.prediction", "rb").readlines()
lines8 = [line8.decode(errors='ignore').strip() for line8 in lines8]

#lines9 = open("./predictions/lez_track1_morph_trial9.prediction", "rb").readlines()
#lines9 = [line9.decode(errors='ignore').strip() for line9 in lines9]

#lines10 = open("./predictions/lez_track1_morph_trial10.prediction", "rb").readlines()
...
major_pred = open('realmajority_Lezgi_test_decodercharmajor3.txt','w')
    ...
    if line_gold.startswith('\g'):
        ...
        for num in range(len(sent_gloss_gold)):
            ...
            #print(sent_gloss9[num])
             ...
             #  if sent_gloss1[num] == sent_gloss_gold[num]:
             ...
             #  if sent_gloss2[num] == sent_gloss_gold[num]:
             #     each_all_gls.append(sent_gloss_gold[num])
             #     each_all_gls.append(sent_gloss_gold[num])
             #     each_all_gls.append(sent_gloss_gold[num])
             #  else:
            ...
            if len(sent_gloss3) >= len(sent_gloss_gold) :
               if sent_gloss3[num] == sent_gloss_gold[num]:
                  each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
            ...
            if len(sent_gloss4) >= len(sent_gloss_gold) :
               if sent_gloss4[num] == sent_gloss_gold[num]:
                  each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
               else:
            ...
            if len(sent_gloss5) >= len(sent_gloss_gold) :
               if sent_gloss5[num] == sent_gloss_gold[num]:
                  each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
            ...
            #   if sent_gloss6[num] == sent_gloss_gold[num]:
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
            #   else:
            ...
            #   if sent_gloss7[num] == sent_gloss_gold[num]:
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
            #   else:
            ...
            if len(sent_gloss8) >= len(sent_gloss_gold):
               if sent_gloss8[num] == sent_gloss_gold[num]:
                  each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
                  #each_all_gls.append(sent_gloss_gold[num])
               else:
            ...
            #   if sent_gloss9[num] == sent_gloss_gold[num]:
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
            #      each_all_gls.append(sent_gloss_gold[num])
             ...
             #  if sent_gloss10[num] == sent_gloss_gold[num]:
              #    each_all_gls.append(sent_gloss_gold[num])
              #    each_all_gls.append(sent_gloss_gold[num])
              #    each_all_gls.append(sent_gloss_gold[num])
              # else:
