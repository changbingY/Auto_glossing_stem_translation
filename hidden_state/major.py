lines_gold = open("./data/Uspanteko/usp-test-track1-uncovered", "rb").readlines()
lines_gold = [line_gold.decode(errors='ignore').strip() for line_gold in lines_gold]

lines = open("./predictions/usp_track1_morph_trial1.prediction", "rb").readlines()
lines = [line.decode(errors='ignore').strip() for line in lines]

lines2 = open("./predictions/usp_track1_morph_trial2.prediction", "rb").readlines()
lines2 = [line2.decode(errors='ignore').strip() for line2 in lines2]

lines3 = open("./predictions/usp_track1_morph_trial3.prediction", "rb").readlines()
lines3 = [line3.decode(errors='ignore').strip() for line3 in lines3]

lines4 = open("./predictions/usp_track1_morph_trial4.prediction", "rb").readlines()
lines4 = [line4.decode(errors='ignore').strip() for line4 in lines4]

lines5 = open("./predictions/usp_track1_morph_trial5.prediction", "rb").readlines()
lines5 = [line5.decode(errors='ignore').strip() for line5 in lines5]

lines6 = open("./predictions/usp_track1_morph_trial6.prediction", "rb").readlines()
lines6 = [line6.decode(errors='ignore').strip() for line6 in lines6]

lines7 = open("./predictions/usp_track1_morph_trial7.prediction", "rb").readlines()
lines7 = [line7.decode(errors='ignore').strip() for line7 in lines7]

lines8 = open("./predictions/usp_track1_morph_trial8.prediction", "rb").readlines()
lines8 = [line8.decode(errors='ignore').strip() for line8 in lines8]

lines9 = open("./predictions/usp_track1_morph_trial9.prediction", "rb").readlines()
lines9 = [line9.decode(errors='ignore').strip() for line9 in lines9]

lines10 = open("./predictions/usp_track1_morph_trial10.prediction", "rb").readlines()
...
major_pred = open('majority_Uspanteko_test_hidden.txt','w')
