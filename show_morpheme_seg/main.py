...
if __name__ == "__main__":
    ...
    if args.model == "ctc":
        model = CTCGlossingModel(
            ...
            # target_char_alphabet_size=dm.target_char_alphabet_size,
    ...
    with open(f"{args.language.lower()}_{args.model}_track{track}.prediction.pkl", "wb") as f:
        pickle.dump(predictions, f)
    
    # Dump morpheme tokenizer
    with open(f"{args.language.lower()}_{args.model}_track{track}.morpheme_tokenizer.pkl", "wb") as f:
        pickle.dump(dm.target_char_tokenizer, f)    
    

    # Dump source tokenizer
    with open(f"{args.language.lower()}_{args.model}_track{track}.source_tokenizer.pkl", "wb") as f:
        pickle.dump(dm.source_tokenizer, f)
