...
def decode_predictions(predictions, source_tokenizer, target_tokenizer):
    ...
    for batch_prediction in predictions:
        ...
        batch_prediction, batch_segmentation, _ = batch_prediction
    ...
    for sentence_prediction, sentence_segmentation in zip(
        ...
        #]
        decoded_sentence_prediction = [
            ["".join(target_tokenizer.lookup_tokens(word_prediction)) for word_prediction in word_predictions]
            for word_predictions in sentence_prediction
        ]
        decoded_sentence_prediction = [
...
def get_predictions(
    ...
    predictions = decode_predictions(
        predictions, dm.source_tokenizer, dm.target_char_tokenizer
    )
    return predictions
